...
class DualSenseUIModel: ObservableObject {
	...
	@objc func updateButtons(_ notification:Notification) {
		...
		// TODO mute button
		self.leftFnButton = o.backLeftTopButton
		self.rightFnButton = o.backRightTopButton
		self.leftPaddle = o.backLeftBottomButton
		self.rightPaddle = o.backRightBottomButton
